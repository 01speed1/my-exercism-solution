...
impl Hand<'_> {
    pub fn new(cards: &str) -> Hand {
        ...
        let porker_hand_points = highest_card.clone().value as u16;
...
impl Hand<'_> {
    fn one_pair(&mut self) {
        ...
        for (key, value) in values.iter() {
            if value == &2 {
                ...
                self.porker_hand_points = *key as u16 * 2u16
            }
        }
    }
    ...
    fn full_house(&mut self) {
        ...
        if some_third_of_a_kind && some_one_pair {
            ...
            self.porker_hand_points = third_of_a_kind_points as u16 + one_pair_points as u16;
        }
    }
    ...
    fn four_of_a_kind(&mut self) {
        ...
        if some_four_of_kind {
            ...
            self.porker_hand_points = four_of_a_kind_points as u16;
        }
    }
    ...
    fn straight_flush(&mut self) {
        ...
        if are_all_suits_equal {
            self.porker_hand = PokerHand::StraightFlush;

            self.porker_hand_points = self.cards.iter().fold(0 as u16, |accumulator, card| {
...
pub mod two_pairs {
    ...
    pub fn hands_with_highest_card<'a>(hands: Vec<Hand<'a>>) -> Vec<Hand<'a>> {
        ...
        let mut highest_card_value = '2' as u8;
